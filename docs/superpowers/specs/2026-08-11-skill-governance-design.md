...
Одна строка на инсайт: инсайт, источник (файл и строка или URL), статус (rejected или deferred), причина. При создании засеивается отложенными пунктами Sol-разбора (мелкие уточнения и наблюдения по одному источнику, не прошедшие входной барьер).
...
2. Создание docs/insights-backlog.md с засевом из Sol-разбора.
