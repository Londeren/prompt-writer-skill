...
- [x] **Step 1: Зафиксировать BASE_RU и базовые метрики**
...
- [x] **Step 3: Карта обратной сборки**
...
- [x] **Step 2: Аудит и финал (dogfooding)**
...
- [x] **Step 2: Frontmatter description - сжать до ≤1024 символов**
...
- [x] **Step 3: Аудит и финал (dogfooding)**
...
- [x] **Step 4: Слой 1 по файлу + commit перевода**
...
- [x] **Step 5: Контентное изменение отдельным коммитом - строка про язык вывода**
...
- [x] **Step 2: Аудит и финал; слой 1 по файлу**
...
- [x] **Step 1: Черновик перевода всех пяти файлов**
...
- [x] **Step 2: Аудит и финал; слой 1 по файлам**
...
- [x] **Step 2: Слой 2 - анкор к tmp/ (субагент)**
...
- [x] **Step 3: Слой 3 - intent-карты (свежие субагенты, адверсариально)**
...
- [x] **Step 4: Слой 4 - обратный перевод (детектор дрейфа)**
...
- [x] **Step 2: Двуязычный смоук-тест**
