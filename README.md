...
3. Применяет 18 master-правил (регистры модальности, decision-type структура, примеры, XML-теги, размещение данных).
...
checklists/
  self-check.md                 — чеклист проверки промпта перед выдачей
```
